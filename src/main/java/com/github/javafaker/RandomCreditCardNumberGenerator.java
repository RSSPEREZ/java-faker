...
public class RandomCreditCardNumberGenerator {
    ...
    public static final String[] ELO_PREFIX_LIST = new String[]{"636368", "636369", "438935", "504175", "451416", "636297", "5067", "4576", "4011", "506699"};

    public static final String[] DINERS_PREFIX_LIST = new String[]{"300",
            "301", "302", "303", "36", "38"};

    public static final String[] HIPER_PREFIX_LIST = new String[]{"38", "60"};

    public static final String[] JCB_PREFIX_LIST = new String[]{"35"};

    public static final String[] HIPERCARD_PREFIX_LIST = new String[]{"606282"};
    ...
    public static String generateDinersNumber() {
        return credit_card_number(DINERS_PREFIX_LIST, 14, 1)[0];
    }

    public static String generateJCBNumber() {
        return credit_card_number(JCB_PREFIX_LIST, 16, 1)[0];
    }

    public static String generateEloNumber() {
        return credit_card_number(ELO_PREFIX_LIST, 16, 1)[0];
    }

    public static String generateHipercardNumber() {
        return credit_card_number(HIPERCARD_PREFIX_LIST, 16, 1)[0];
    }

    public static String generateHiperNumber() {
        return credit_card_number(HIPER_PREFIX_LIST, 16, 1)[0];
    }
